...
public static class BangumiApiExtensions
{
    ...
    public static AsyncPagedDataCollection<SearchResponsedSubject> SearchSubjects(this IBangumiClient client, SearchSubjectsRequestBody? requestBody, int? pageLimit = null, AsyncPageCollectionOptions? options = null)
    {
    ...
    /// <param name="options"></param>
    /// <returns></returns>
    public static AsyncPagedDataCollection<Subject> GetSubjects(this IBangumiClient client, GetSubjectsQuery query, int? pageLimit = null, AsyncPageCollectionOptions? options = null)
    {
        query = query.Clone();
    ...
    /// <returns></returns>
    [Experimental(BangumiApis.ExperimentalApiDiagnosticId)]
    public static AsyncPagedDataCollection<Character> SearchCharacters(this IBangumiClient client, SearchCharactersRequestBody? requestBody, int? pageLimit = null, AsyncPageCollectionOptions? options = null)
    {
        requestBody = requestBody?.Clone();
    ...
    /// <returns></returns>
    [Experimental(BangumiApis.ExperimentalApiDiagnosticId)]
    public static AsyncPagedDataCollection<Person> SearchPersons(this IBangumiClient client, SearchPersonsRequestBody? requestBody, int? pageLimit = null, AsyncPageCollectionOptions? options = null)
    {
        requestBody = requestBody?.Clone();
        return new(pageLimit, options ?? AsyncPageCollectionOptions.Default,
